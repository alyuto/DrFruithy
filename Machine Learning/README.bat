# Machine learning
- Dr.Fruithy is an application to detect diseases in fruit plants by detecting the leaves of the fruit plants. 
- The model built using Convolutional Neural Network architecture
